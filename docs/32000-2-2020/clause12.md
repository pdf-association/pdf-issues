...
<p class ="editornote">EDITOR NOTE: The remaining text in subclause 12.6.4.8 about <b>Base</b> and the URI dictionary (including Table 211 and NOTE) applies to all relative URIs in a PDF document and is not limited to only URI actions as is currently implied. 
